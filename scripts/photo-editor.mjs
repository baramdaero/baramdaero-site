...
const GROUPS = [['care-pricing-basis', '가격'], ['install-pricing-basis', '가격'], ['newhome-pricing-basis', '미사용'], ['care-process-', '세척 · 진행 절차'], ['care-symptom-', '세척 · 증상'], ['care-', '세척'], ['home-', '홈'], ['install-', '설치'], ['newhome-', '신축 입주'], ['commercial-', '상업용']];
